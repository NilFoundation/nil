...
// Hash: 29b1c0d207748f5b8eadda06d4b3c433afae8a7d09fa5fbe36260eac1b8a82b7
// Version: 0.1.3
package mpt
...
func (l *LeafNode) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	// Field (1) 'LeafData'
	if size := len(l.LeafData); size > 100000000 {
		err = ssz.ErrBytesLengthFn("LeafNode.LeafData", size, 100000000)
		return
	}
...
func (l *LeafNode) HashTreeRootWith(hh ssz.HashWalker) (err error) {
	...
	// Field (1) 'LeafData'
	{
		...
		if byteLen > 100000000 {
			err = ssz.ErrIncorrectListSize
			return
		}
		hh.Append(l.LeafData)
		hh.MerkleizeWithMixin(elemIndx, byteLen, (100000000+31)/32)
	}
...
func (b *BranchNode) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	// Field (1) 'Value'
	if size := len(b.Value); size > 100000000 {
		err = ssz.ErrBytesLengthFn("BranchNode.Value", size, 100000000)
		return
	}
