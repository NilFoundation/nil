...
//go:generate go run github.com/NilFoundation/fastssz/sszgen --path message.go -include ../../common/length.go,address.go,uint256.go,code.go,shard.go,bloom.go,log.go,../../common/hash.go,signature.go,account.go,bitflags.go --objs Message,ExternalMessage,InternalMessagePayload,messageDigest,MessageFlags
...
//go:generate go run github.com/NilFoundation/fastssz/sszgen --path account.go -include ../../common/length.go,message.go,address.go,uint256.go,code.go,shard.go,bloom.go,log.go,../../common/hash.go --objs SmartContract,CurrencyBalance
