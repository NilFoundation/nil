...
//go:generate go run github.com/NilFoundation/fastssz/sszgen --path message.go -include ../../common/length.go,address.go,uint256.go,code.go,shard.go,bloom.go,log.go,../../common/hash.go,signature.go --objs Message,ExternalMessage,InternalMessagePayload,messageDigest
