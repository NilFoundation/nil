...
//go:generate go run github.com/ferranbt/fastssz/sszgen --path messages.go -include account.go,address.go,uint256.go,code.go,shard.go,bloom.go,log.go,../../common/hash.go,../../common/signature.go --objs DeployMessage,AddressSourceData
