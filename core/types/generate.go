...
//go:generate go run github.com/ferranbt/fastssz/sszgen --path block.go -include bloom.go,log.go,../../common/length.go,../../common/address.go,../../common/hash.go --objs Block
