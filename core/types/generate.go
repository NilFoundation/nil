...
//go:generate go run github.com/NilFoundation/fastssz/sszgen --path receipt.go -include ../../common/length.go,address.go,gas.go,block.go,bloom.go,log.go,message.go,../../common/hash.go --objs Receipt
