...
// Hash: fa5c65afb35bb5811b9a834aacc4b346058cf08c232f68227ea5860f2422724e
// Version: 0.1.3
package db
...
func (b *BlockHashAndMessageIndex) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	dst = ssz.MarshalUint64(dst, b.MessageIndex)
...
func (b *BlockHashAndMessageIndex) UnmarshalSSZ(buf []byte) error {
	...
	// Field (1) 'MessageIndex'
	b.MessageIndex = ssz.UnmarshallUint64(buf[32:40])
