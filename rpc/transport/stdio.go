...
func DialStdIO(ctx context.Context, logger *zerolog.Logger) (*Client, error) {
	return DialIO(ctx, os.Stdin, os.Stdout, logger)
}

// DialIO creates a client which uses the given IO channels
func DialIO(ctx context.Context, in io.Reader, out io.Writer, logger *zerolog.Logger) (*Client, error) {
