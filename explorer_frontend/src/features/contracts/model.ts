...
export const $activeApp = createStore<{ bytecode: `0x${string}`; address?: Address } | null>(null);

export const choseApp = createEvent<{ bytecode: `0x${string}`; address?: Address }>();
...
export const setParams = createEvent<{ functionName: string; paramName: string; value: unknown }>();
...
>(async ({ abi, functionName, args, wallet, address, value }) => {
  console.log({
    abi,
    functionName,
    args,
