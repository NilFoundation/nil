...
contract NilRollupTest is BaseTest {
    ...
    function generateBatchData() public returns (BatchData memory) {
        ...
        bytes memory sampleValidityProof =
            hex"";
    ...
    function test_revert_when_updateState_with_dataProofsAndBlobCountMismatch() external {
        ...
        vm.expectRevert(
            abi.encodeWithSelector(
                INilRollup.ErrorDataProofsAndBlobCountMismatch.selector, dataProofs.length, blobCount
            )
        );
