...
export async function bridgeERC20ViaRouter() {
    ...
    const tx = await l1BridgeRouterInstance.depositERC20(erc20TokenData.address, token_amount, l2DepositRecipientAddress, l2FeeRefundAddress, gasLimit, userMaxFeePerGas, userMaxPriorityFeePerGas, { value: total_native_amount });
