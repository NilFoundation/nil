...
<CookbookCardSection>
  <CookbookCard badges={[CookbookBadges[0]]} tag={{
    label: "8 min read",
  }} id='swap1' title='Design the swap contract' description='' to='./swap/create-swap-contract'
  />
  <CookbookCard badges={[CookbookBadges[2]]} tag={{
    label: "7 min read",
  }} id='swap2' title='Deploy and test the swap contract' description='' to='./swap/deploy-test-swap'/>
</CookbookCardSection>