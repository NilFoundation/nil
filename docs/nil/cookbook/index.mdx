...
These recipes demonstrate how to call [**the Faucet service**](../getting-started/essentials/tokens-multi-currency.mdx#currency-faucet-service) via `Nil.js`.
...
It is possible to use `Nil.js` in a Node.js environment, making it possible to perform server-side operations on =nil;. The **Cookbook** provides a simple Node.js project that handles new wallet creation entirely server-side.
