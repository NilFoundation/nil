...
1. A user submits a transaction via an external message
...
11. The sync commitee sends a transaction proposing the new state to L1. This transaction contains the ZKP
