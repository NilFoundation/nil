...
<CardSection>
    <Card id='nil101' title='=nil; 101' description='Start building using developer tools' to='https://docs.nil.foundation/nil/getting-started/nil-101'/>
    <Card id='getting-started' title='Getting started' description='Learn how to perform essential operations on the cluster' to='https://docs.nil.foundation/nil/getting-started/essentials/creating-a-wallet'/>
</CardSection>
...
<CardSection>
    <Card id='principles' title='Principles' description='Grasp the key tenets of =nil;' to='https://docs.nil.foundation/nil/specification/principles'/>
    ...
    <Card id='sequencing' title='Sequencing' description='Read about how =nil; adopts the PBS model' to='https://docs.nil.foundation/nil/specification/sequencing'/>
    <Card id='finality' title='Finality' description='Learn about the strong security guarantees of =nil;' to='https://docs.nil.foundation/nil/specification/finality'/>
    <Card id='data' title='Data availability' description='See how =nil; achieves DA at all levels' to='https://docs.nil.foundation/nil/specification/data-availability'/>
    <Card id='contract' title='Contract placement' description='Ensure account placement on the same shard' to='https://docs.nil.foundation/nil/specification/contract-co-location'/>
</CardSection>
