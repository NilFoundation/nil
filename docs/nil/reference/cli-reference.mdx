...
This command enables ABI encoding and decoding.

### Subcommands

| Subcommand | Definition |
|:--:|:--|
| `decode` | Decodes the result of a contract call. |
| `encode` | Encode the inputs for a contract call. |

### Flags

The following flags can be used with any subcommand or without a subcommand:

| Flag | Definition |
|:--:|:--|
| `--path` | Specify the path to the contract ABI file. |
...
| Subcommand | Definition |
|:--:|:--|
| `create-currency` | Create a new currency and withdraw it. |
| `mint-currency` | Mint an existing currency and withdraw it.  |
...
The command returns the current version of the =nil; CLI.
