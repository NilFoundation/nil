...
<PGButton name="RetailerManufacturer.sol"/>
...
```bash showLineNumbers file=../../../tests/compilationCommands.js start=startRetailerCompilation end=endRetailerCompilation
```

Compile Contract 2 with:

```bash showLineNumbers file=../../../tests/compilationCommands.js start=startManufacturerCompilation end=endManufacturerCompilation
```
