...
```typescript showLineNumbers file=../../../tests/creating-a-wallet.test.mjs start=startNilJSWalletImports end=endNilJSWalletImports
```

```typescript showLineNumbers file=../../../tests/creating-a-wallet.test.mjs start=startNilJSWalletCreation end=endNilJSWalletCreation
```
