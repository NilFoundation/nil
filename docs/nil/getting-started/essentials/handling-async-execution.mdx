...
To support [**cross-shard communication**](../../specification/principles.mdx#cross-shard-communication), =nil; supports smart contracts making async calls to one another directly in Solidity code.
...
<PGButton name="AwaiterCounter.sol"/>
...
Contract 2 is [**the`Counter` contract**](getting-started/nil-101.mdx#flow-1).
