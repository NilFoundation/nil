...
This Nil.js example sends a message from the user's wallet to another contract. It estimates the gas price to be `100n` and is willing to pay for a maximum of `1_000_000n` units of gas. 
