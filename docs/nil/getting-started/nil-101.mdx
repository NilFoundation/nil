...
```bash file=../../tests/nil-101.test.js start=startKeygen end=endKeygen
```

To point the CLI toward the RPC endpoint:

```bash file=../../tests/nil-101.test.js start=startEndpoint end=endEndpoint
```
...
```bash file=../../tests/nil-101.test.js start=startWallet end=endWallet
```
...
```bash file=../../tests/nil-101.test.js start=startTopup end=endTopup
```

To see the wallet address and its public key:

```bash file=../../tests/nil-101.test.js start=startInfo end=endInfo
```
...
```bash file=../../tests/nil-101.test.js start=startCompilation end=endCompilation
```

Deploy a contract with the =nil; CLI:

```bash file=../../tests/nil-101.test.js start=startDeploy end=endDeploy
...
```bash file=../../tests/nil-101.test.js start=startIncrement end=endIncrement
```

Retrieve the result:

```bash file=../../tests/nil-101.test.js start=start_CallToIncrementer end=end_CallToIncrementer
```
...
```bash file=../../tests/nil-101.test.js start=startCallerCompilation end=endCallerCompilation
```

```bash file=../../tests/nil-101.test.js start=start_CallerDeploy end=end_CallerDeploy
```
...
```bash file=../../tests/nil-101.test.js start=start_SendTokensToCaller end=end_SendTokensToCaller
```

```bash file=../../tests/nil-101.test.js start=startMessageFromCallerToIncrementer end=endMessageFromCallerToIncrementer
```
...
```bash file=../../tests/nil-101.test.js start=startNewWalletDeploy end=endNewWalletDeploy
```

Create a new currency and withdraw it:

```bash file=../../tests/nil-101.test.js start=startMintWithdrawCurrency end=endMintWithdrawCurrency

```

Check the currencies of the wallet:

```bash file=../../tests/nil-101.test.js start=startCurrenciesCheck end=endCurrenciesCheck
```
