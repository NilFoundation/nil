...
const RETAILER_COMPILATION_COMMAND = 'solc -o ./tests/Retailer --bin --abi ./tests/Retailer.sol --overwrite';
//endRetailerCompilation

//startManufacturerCompilation
const MANUFACTURER_COMPILATION_COMMAND = 'solc -o ./tests/Manufacturer --bin --abi ./tests/Manufacturer.sol --overwrite';
