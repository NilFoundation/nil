...
func TestEventTupleUnpack(t *testing.T) { //nolint:tparallel
	t.Parallel()
	...
	addr := types.HexToAddress("0x00Ce0d46d924CC8437c806721496599FC3FFA268")
	testCases := []struct {
		data     string
		dest     interface{}
		expected interface{}
...
func unpackTestEventData(dest interface{}, hexData string, jsonEvent []byte, assert *assert.Assertions) error {
	...
	var e Event
	assert.NoError(json.Unmarshal(jsonEvent, &e), "Should be able to unmarshal event ABI") //nolint:musttag
