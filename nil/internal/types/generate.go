...
//go:generate go run github.com/NilFoundation/fastssz/sszgen --path receipt.go -include ../../common/length.go,address.go,gas.go,value.go,block.go,bloom.go,log.go,message.go,exec_errors.go,../../common/hash.go --objs Receipt
//go:generate go run github.com/NilFoundation/fastssz/sszgen --path message.go -include ../../common/length.go,address.go,gas.go,value.go,uint256.go,code.go,shard.go,bloom.go,log.go,../../common/hash.go,signature.go,account.go,bitflags.go --objs Message,ExternalMessage,InternalMessagePayload,messageDigest,MessageFlags,EvmState,AsyncContext,AsyncResponsePayload
