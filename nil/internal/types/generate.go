...
//go:generate go run github.com/NilFoundation/fastssz/sszgen --path log.go -include ../../common/length.go,address.go,../../common/hash.go,block.go,uint256.go --objs Log,DebugLog
//go:generate go run github.com/NilFoundation/fastssz/sszgen --path receipt.go -include ../../common/length.go,address.go,gas.go,value.go,block.go,bloom.go,log.go,message.go,exec_errors.go,../../common/hash.go,uint256.go --objs Receipt
