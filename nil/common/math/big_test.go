...
func TestBigEndianByteAt(t *testing.T) {
	...
	for _, test := range tests {
		v := new(big.Int).SetBytes(ethcommon.Hex2Bytes(test.x))
...
func TestExp(t *testing.T) {
	...
	tests := []struct{ base, exponent, result *big.Int }{
		...
		{base: big.NewInt(3), exponent: big.NewInt(144), result: MustParseBig256(
			"507528786056415600719754159741696356908742250191663887263627442114881")},
		{base: big.NewInt(2), exponent: big.NewInt(255), result: MustParseBig256(
