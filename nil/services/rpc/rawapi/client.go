...
type (
	doApiRequestFunction                     func(codec *methodCodec, methodName string, ctx context.Context, args ...any) ([]byte, error)
	nodeApiSetter                            func(NodeApi)
	setAsP2pRequestHandlersIfAllowedFunction func(ctx context.Context, networkManager *network.Manager, readonly bool, logger zerolog.Logger) error
)
...
func NewLocalRawApiAccessor(shardId types.ShardId, rawapi *LocalShardApi) (*ShardApiAccessor, error) {
	return newDirectRawApiAccessor(shardId, rawapi, reflect.TypeFor[ShardApi](), reflect.TypeFor[NetworkTransportProtocol]())
}

func newNetworkRawApiAccessor(shardId types.ShardId, networkManager *network.Manager, apiType, transportType reflect.Type) (*ShardApiAccessor, error) {
	...
	return &ShardApiAccessor{
		...
		onSetAsP2pRequestHandlersIfAllowed: func(ctx context.Context, networkManager *network.Manager, readonly bool, logger zerolog.Logger) error {
			return nil
		},
	}, nil
}

func newDirectRawApiAccessor(shardId types.ShardId, rawapi ShardApi, apiType, transportType reflect.Type) (*ShardApiAccessor, error) {
	codec, err := newApiCodec(apiType, transportType)
	if err != nil {
		return nil, err
	}
...
func makeDoNetworkRawApiRequestFunction(networkManager *network.Manager, shardId types.ShardId, apiName string) doApiRequestFunction {
...
func (api *ShardApiAccessor) GetBlockTransactionCount(ctx context.Context, blockReference rawapitypes.BlockReference) (uint64, error) {
	return sendRequestAndGetResponseWithCallerMethodName[uint64](ctx, api, "GetBlockTransactionCount", blockReference)
}

func (api *ShardApiAccessor) GetBalance(ctx context.Context, address types.Address, blockReference rawapitypes.BlockReference) (types.Value, error) {
	return sendRequestAndGetResponseWithCallerMethodName[types.Value](ctx, api, "GetBalance", address, blockReference)
}

func (api *ShardApiAccessor) GetCode(ctx context.Context, address types.Address, blockReference rawapitypes.BlockReference) (types.Code, error) {
	return sendRequestAndGetResponseWithCallerMethodName[types.Code](ctx, api, "GetCode", address, blockReference)
}

func (api *ShardApiAccessor) GetCurrencies(ctx context.Context, address types.Address, blockReference rawapitypes.BlockReference) (map[types.CurrencyId]types.Value, error) {
...
func (api *ShardApiAccessor) GetContract(ctx context.Context, address types.Address, blockReference rawapitypes.BlockReference) (*rawapitypes.SmartContract, error) {
...
func (api *ShardApiAccessor) GetInMessageReceipt(ctx context.Context, hash common.Hash) (*rawapitypes.ReceiptInfo, error) {
...
func (api *ShardApiAccessor) GetMessageCount(ctx context.Context, address types.Address, blockReference rawapitypes.BlockReference) (uint64, error) {
	return sendRequestAndGetResponseWithCallerMethodName[uint64](ctx, api, "GetMessageCount", address, blockReference)
}

func (api *ShardApiAccessor) SendMessage(ctx context.Context, message []byte) (msgpool.DiscardReason, error) {
...
func (api *ShardApiAccessor) setAsP2pRequestHandlersIfAllowed(ctx context.Context, networkManager *network.Manager, readonly bool, logger zerolog.Logger) error {
	return api.onSetAsP2pRequestHandlersIfAllowed(ctx, networkManager, readonly, logger)
}

func sendRequestAndGetResponseWithCallerMethodName[ResponseType any](ctx context.Context, api *ShardApiAccessor, methodName string, args ...any) (ResponseType, error) {
	if assert.Enable {
...
func sendRequestAndGetResponse[ResponseType any](doApiRequest doApiRequestFunction, apiCodec apiCodec, methodName string, ctx context.Context, args ...any) (ResponseType, error) {
