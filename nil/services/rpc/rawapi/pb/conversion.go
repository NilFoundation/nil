...
func (txn *RawTxnsResponse) PackProtoMessage(txnWithHash []*types.Transaction, err error) error {
	if err != nil {
	...
	var rawTxns RawTxns
	rawTxns.Data, err = sszx.EncodeContainer[*types.Transaction](txnWithHash)
	if err != nil {
		return err
	}
