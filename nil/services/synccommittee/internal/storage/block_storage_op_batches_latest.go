...
// latestBatchOp represents the set of operations to manage the latest batch ID state in the storage.
type latestBatchOp struct{}

func newLatestBatchOp() latestBatchOp {
	return latestBatchOp{}
}

func (t latestBatchOp) updateLatestBatchId(tx db.RwTx, batch *scTypes.BlockBatch) error {
...
func (latestBatchOp) getLatestBatchId(tx db.RoTx) (*scTypes.BatchId, error) {
...
func (latestBatchOp) validateLatestBatchId(batch *scTypes.BlockBatch, latestBatchId *scTypes.BatchId) error {
	var isValid bool
	switch {
...
func (latestBatchOp) putLatestBatchId(tx db.RwTx, batchId *scTypes.BatchId) error {
	var bytes []byte
