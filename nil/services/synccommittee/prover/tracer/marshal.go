...
var (
	...
	marshalModeToMarshaller = map[MarshalMode]marshaler{
		...
		MarshalModeJSON: func(msg proto.Message) ([]byte, error) {
...
func marshalToFile[Msg proto.Message](msg Msg, marshalFunc marshaler, filename string) error {
	data, err := marshalFunc(msg)
	if err != nil {
		return err
	}
