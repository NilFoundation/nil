...
func (s *SuiteFaucet) createSmartAccountViaFaucet(
	shardId types.ShardId, ownerPrivateKey *ecdsa.PrivateKey, value int64,
) types.Address {
	s.T().Helper()
...
func (s *SuiteFaucet) TestCreateSmartAccountViaFaucet() {
	...
	smartAccountAddress := s.createSmartAccountViaFaucet(types.BaseShardId, userPrivateKey, value)
