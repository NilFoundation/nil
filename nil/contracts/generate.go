...
//go:generate bash -c "ln -nsf ../.. @nilfoundation && solc ../../uniswap/contracts/*.sol --bin --abi --hashes --overwrite -o ./compiled/uniswap --allow-paths .,../.. --via-ir --optimize && rm @nilfoundation"
//go:embed compiled/*
var Fs embed.FS
