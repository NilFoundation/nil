...
task(
  ...
  console.log(`Oracle price set for USDT at tx hash ${setOraclePriceUSDT.hash}`);
  ...
  console.log(`Account 1 deposited 12 USDT at tx hash ${depositUSDTResponse.hash}`);
  ...
  console.log(`Account 2 deposited 1 ETH at tx hash ${depositETHResponse.hash}`);
