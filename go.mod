...
require (
	...
	gvisor.dev/gvisor v0.0.0-20250628022234-501a6637cc98 // indirect
)
...
replace github.com/dgraph-io/badger/v4 => github.com/NilFoundation/badger/v4 v4.2.1-0.20250630110219-48142f2da959
